...
server
    ...
    .option('-p --server-port <port>', 'server port, default: 9999')
...
function startWorker(id) {
    ...
    var relay = new TCPRelay({
        ...
        serverPort: process.env['PORT'] || server.serverPort || 9999,
        password: process.env['PASSWORD'] || server.password || 'shadowsocks',
